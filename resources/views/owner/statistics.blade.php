    ...
    <aside class="fixed inset-y-0 left-0 z-20 flex w-48 flex-col bg-[#3E1F0F] shadow-xl overflow-y-auto">
        ...
        <nav class="flex-1 space-y-8 px-4 py-4">
            ...
            <a href="{{ route('owner.statistics') }}"
               class="flex items-center gap-3 rounded-2xl bg-[#64391F] p-4 shadow-lg transition">
                <svg class="h-12 w-12 flex-shrink-0 text-[#F5E2D0]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                </svg>
                <span class="text-xs font-bold text-[#F5E2D0]">Statistik</span>
            </a>
            
            {{-- Kelola Menu --}}
            <a href="{{ route('owner.menu-items.index') }}"
               class="flex items-center gap-3 px-4 transition hover:opacity-80">
                <svg class="h-12 w-12 flex-shrink-0 text-[#C69C7E]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                <span class="text-xs font-bold text-[#E1BCA0] leading-tight">Kelola<br>Menu</span>
            </a>
            ...
            <a href="{{ route('owner.categories.index') }}"
               class="flex items-center gap-3 px-4 transition hover:opacity-80">
                ...
                <span class="text-xs font-bold text-[#E1BCA0] leading-tight">Kelola<br>Kategori</span>
            </a>
            ...
            <a href="{{ route('owner.tables.index') }}"
               class="flex items-center gap-3 px-4 transition hover:opacity-80">
                ...
                <span class="text-xs font-bold text-[#E1BCA0] leading-tight">Kelola<br>Meja</span>
            </a>
        </nav>
